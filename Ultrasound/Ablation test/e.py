...
echo_dataset_test = EchoDataset(echo_test_data)
...
# 创建 DataLoader
batch_size = 128  # 增加 batch size 以提高 GPU 使用率
num_workers = 16  # 提高 num_workers 加快数据加载
...
test_loader = DataLoader(echo_dataset_test, batch_size=batch_size, shuffle=False, num_workers=num_workers, pin_memory=pin_memory)
